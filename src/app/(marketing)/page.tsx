                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            ...
                            <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                                <Link href="#" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-4 shadow-3xl shadow-background/40 cursor-pointer select-none">
                        ...
                        <div className="relative flex items-center py-10 md:py-20 w-full justify-center px-4">
                            {/* Your original background gradient glow */}
                            <div className="absolute top-1/2 left-1/2 -z-10 gradient w-3/4 -translate-x-1/2 h-3/4 -translate-y-1/2 inset-0 blur-[10rem]"></div>
                            
                            {/* Banner Container inspired by layout in image_e3a0f6.png */}
                            <div className="relative rounded-2xl border border-foreground/10 p-8 md:p-12 bg-background/20 backdrop-blur-3xl w-full max-w-5xl shadow-2xl overflow-hidden">
                                
                                {/* Curved graphic asset mimicking the accent shape in image_e3a0f6.png */}
                                <div className="absolute bottom-0 right-1/4 translate-x-1/4 pointer-events-none opacity-20 hidden md:block">
                                    <svg width="340" height="180" viewBox="0 0 340 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 180C120 180 150 40 170 0C190 40 220 180 340 180H0Z" fill="url(#banner-accent-grad)" />
                                        <defs>
                                            <linearGradient id="banner-accent-grad" x1="170" y1="0" x2="170" y2="180" gradientUnits="userSpaceOnUse">
                                ...
                                <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6 w-full">
                                    ...
                                    <div className="space-y-3 max-w-2xl text-left">
                                        <h3 className="text-3xl md:text-4xl font-semibold tracking-tight text-white leading-tight">
                                            Ready to scale? <span className="text-blue-500">Let&apos;s talk.</span>
                                        </h3>
                                        <p className="text-base text-zinc-400">
                                            Our platform empowers businesses to build safer, more trustworthy digital experiences. Get in touch with us to see how we can help your workflow.
                                        </p>
                                    </div>
                                    ...
                                    <div className="shrink-0 flex items-center">
                                        <Link 
                                            href="/contact" 
                                            className="inline-flex items-center justify-center rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 bg-blue-600 text-white hover:bg-blue-500 h-11 px-6 shadow-xl shadow-blue-600/20 w-full sm:w-auto font-semibold tracking-wide"
                                        >
                                            Get Started
                                        </Link>
                                    </div>
                                ...
                                {/* Your original animating border highlight */}
